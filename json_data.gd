...
export var wtile_to_item = {0: "rock_wall", 1: "granite_wall", 2: "iron_ore"}
export var ptile_to_item = {0: "red_shroom", 1: "yellow_shroom", 2: "stalagmite", 3: "cave_grass", 4: "glow_bell"}
